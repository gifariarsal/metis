...
const Teknologi = () => {
  ...
  const fetchData = async () => {
    try {
      const url = `https://minpro-blog.purwadhikabootcamp.com/api/blog?id_cat=3&sort=DESC&page=${index}&size=10&orderBy=total_fav`;
  ...
  return (
    <Box>
      <Box m={"40px 0px 16px"}>
        <Heading fontSize={"4xl"}>Technology</Heading>
      </Box>
      <Box>
