...
const Fiksi = () => {
  ...
  const fetchData = async () => {
    try {
      const url = `https://minpro-blog.purwadhikabootcamp.com/api/blog?id_cat=7&sort=DESC&page=${index}&size=10&orderBy=total_fav`;
  ...
  return (
    <Box>
      <Box m={"40px 0px 16px"}>
        <Heading fontSize={"4xl"}>Fiction</Heading>
      </Box>
      <Box>
